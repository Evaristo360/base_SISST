...
function IsGuardadoParcial() {
    $('.GuardarParcial').on('click', function (e) {
        CleanErrors('#formIncidenteContratista');
        $('#GuardadoParcial').val(true);

        //partial save only requires Trabajador and Fecha Incidente
        $('#formIncidenteContratista').data('validator').settings.ignore = ".guardadoTotal";
        validateForm = true;
        var validationModel = $("#formIncidenteContratista").valid();
        if (!validationModel) {
            validateForm = false;
        }
    });
...
function IsGuardadoTotal() {
    $('.GuardarTotal').on('click', function (e) {
        ...
        $('#formIncidenteContratista').data('validator').settings.ignore = ".trabajadorSearchVC, .ignoreValidation";
        validateForm = true;
        var validationModel = $("#formIncidenteContratista").valid();
        if (!validationModel) {
            validateForm = false;
...
function CommonIncidenteContratistaSetup() {
    //datos trabajador tab
...
$(document).ready(function () {
    ...
    $('#formIncidenteContratista').find("[data-valmsg-summary=true]")
