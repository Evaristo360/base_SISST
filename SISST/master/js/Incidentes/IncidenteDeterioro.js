/*
 *
 * general Incidente Deterioro functions
 *
 * */
...
function IsGuardadoParcial() {
    $('.GuardarParcial').on('click', function (e) {
        CleanErrors('#formIncidenteDeterioro');
        $('#GuardadoParcial').val(true);

        //partial save only requires Trabajador and Fecha Incidente
        $('#formIncidenteDeterioro').data('validator').settings.ignore = ".guardadoTotal";
        validateForm = true;
        var validationModel = $("#formIncidenteDeterioro").valid();
        if (!validationModel) {
            validateForm = false;
        }
    });
...
function IsGuardadoTotal() {
    $('.GuardarTotal').on('click', function (e) {
        ...
        $('#formIncidenteDeterioro').data('validator').settings.ignore = ".trabajadorSearchVC, .ignoreValidation";
        validateForm = true;
        var validationModel = $("#formIncidenteDeterioro").valid();
        if (!validationModel) {
            validateForm = false;
...
/*
 *
 * init Incidente Deterioro functions
 *
 * */
...
function CommonIncidenteDeterioroSetup() {
    //datos trabajador tab
...
/*
 *
 * validation Incidente Deterioro functions
 *
 * */
...
$(document).ready(function () {
    ...
    $('#formIncidenteDeterioro').find("[data-valmsg-summary=true]")
