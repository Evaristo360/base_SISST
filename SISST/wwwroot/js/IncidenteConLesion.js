...
function IsGuardadoParcial() {
    $('.GuardarParcial').on('click', function (e) {
        CleanErrors('#formIncidenteConLesion');
        $('#GuardadoParcial').val(true);

        //partial save only requires Trabajador and Fecha Incidente
        $('#formIncidenteConLesion').data('validator').settings.ignore = ".guardadoTotal";
        validateForm = true;
        var validationModel = $("#formIncidenteConLesion").valid();
        if (!validationModel) {
            validateForm = false;
        }
    });
...
function IsGuardadoTotal() {
    $('.GuardarTotal').on('click', function (e) {
        ...
        $('#formIncidenteConLesion').data('validator').settings.ignore = ".trabajadorSearchVC, .ignoreValidation";
        validateForm = true;
        var validationModel = $("#formIncidenteConLesion").valid();
        if (!validationModel) {
            validateForm = false;
...
$(document).ready(function () {
    ...
    $('#formIncidenteConLesion').find("[data-valmsg-summary=true]")
