...
{
    public class OpcionDeleteEventHandler : INotificationHandler<OpcionDeleteCommand>
    {
        private readonly ApplicationDbContext _context;
        private readonly ILogger<OpcionDeleteEventHandler> _logger;
        public OpcionDeleteEventHandler( ApplicationDbContext context, 
            ILogger<OpcionDeleteEventHandler> logger )
        {
            _context = context;
            _logger = logger;
        }
        public async Task Handle(OpcionDeleteCommand notification, CancellationToken cancellationToken)
        {
            ...
            var  catalogo = _context.Catalogo.First(c => c.CatalogoId.Equals(notification.CatalogoId));
